...
const S = {
  ...
  sponsorVisit: { ka: 'ვებგვერდზე გადასვლა', en: 'Visit website' },
  close: { ka: 'დახურვა', en: 'Close' },
  howToWinTitle: { ka: 'როგორ იმარჯვებ', en: 'How you win' },
  howToWin1: { ka: 'მიაწოდე ენერგია ყველა სახლს', en: 'Keep every home powered' },
  howToWin2: { ka: 'მოიპოვე ხალხის ნდობა', en: 'Earn the people’s trust' },
  howToWin3: { ka: 'დადე ევროპული კაბელის კონტრაქტი', en: 'Win the EU cable contract' },
  play: { ka: 'თამაში', en: 'Play' },
  demoJump: { ka: 'დემო — ნამახვანის გადაწყვეტილება (აქტი II)', en: 'Demo — the Namakhvani decision (Act II)' },
  continue: { ka: 'განაგრძე', en: 'Continue' },
  chooseRegion: { ka: 'აირჩიე რეგიონი', en: 'Choose your region' },
  regionSelectLead: {
    ka: 'რუკაზე აირჩიე ადგილი, რომლის ენერგეტიკულ მომავალსაც შექმნი.',
    en: 'Choose the place whose energy future you want to shape.',
  },
  regionMapAria: { ka: 'საქართველოს სათამაშო რეგიონების ინტერაქტიული რუკა', en: 'Interactive map of playable Georgian regions' },
  regionMapHint: {
    ka: 'დააჭირე რეგიონს — ან გადადი Tab-ით — და შეადარე მისი რესურსები.',
    en: 'Select a region — or use Tab — to compare its resources.',
  },
  mapBlackSea: { ka: 'შავი ზღვა', en: 'Black Sea' },
  regionAlreadyChosen: { ka: 'უკვე შენი ქსელის ნაწილია', en: 'Already part of your network' },
  regionSelectedLabel: { ka: 'არჩეული რეგიონი', en: 'Selected region' },
  recommendedRegion: { ka: 'კარგია პირველი თამაშისთვის', en: 'Great for a first game' },
  regionResourceFit: { ka: 'ენერგეტიკული რესურსები', en: 'Energy resources' },
  strongestResource: { ka: 'ძლიერი მხარე', en: 'Strongest resource' },
  startingTrustLabel: { ka: 'საწყისი ნდობა', en: 'Starting trust' },
  startingDemandLabel: { ka: 'საწყისი მოთხოვნა', en: 'Starting demand' },
  availableSitesLabel: { ka: 'სამშენებლო ადგილები', en: 'Build sites' },
  regionChallengeLabel: { ka: 'ადგილობრივი გამოწვევა', en: 'Local challenge' },
  regionPreviewEmptyTitle: { ka: 'აირჩიე რეგიონი რუკაზე', en: 'Pick a region on the map' },
  regionPreviewEmptyDesc: {
    ka: 'შეადარე მზე, ქარი, წყალი და ადგილობრივი გამოწვევა, შემდეგ დაადასტურე არჩევანი.',
    en: 'Compare sun, wind, water and the local challenge, then confirm your choice.',
  },
  startInRegion: { ka: 'დაიწყე ამ რეგიონში', en: 'Start in this region' },
  confirmExpansion: { ka: 'ქსელში დამატება', en: 'Add to my grid' },
  back: { ka: 'უკან', en: 'Back' },
  turn: { ka: 'სვლა', en: 'Turn' },
  endTurn: { ka: 'კვარტალის გაშვება', en: 'Run quarter' },
  build: { ka: 'აშენება', en: 'Build' },
  trust: { ka: 'ნდობა', en: 'Trust' },
  market: { ka: 'ბაზარი', en: 'Market' },
  actionsMenu: { ka: 'მოქმედებები', en: 'Actions' },
  missionExpand: { ka: 'მისიის გაშლა', en: 'Expand mission' },
  missionCollapse: { ka: 'მისიის აკეცვა', en: 'Collapse mission' },
  money: { ka: 'ფული', en: 'Money' },
  supply: { ka: 'მიწოდება', en: 'Supply' },
  demand: { ka: 'მოთხოვნა', en: 'Demand' },
  supplyLabel: { ka: 'მიწოდება', en: 'Supply' },
  ...
  nationalMapBtn: { ka: 'რუკა', en: 'Map' },
  nationalMapTitle: { ka: 'საქართველოს რუკა', en: 'Map of Georgia' },
  nationalMapSwitchHint: { ka: 'აირჩიე შენი რეგიონი გასაგრძელებლად.', en: 'Tap your region to continue there.' },
  nationalMapExpandHint: { ka: 'ახალი რეგიონი ხელმისაწვდომია — შეეხე გასახსნელად.', en: 'A new region is available — tap it to unlock.' },
  nationalMapLockedHint: { ka: 'მეორე რეგიონი მე-2 აქტში იხსნება.', en: 'A second region unlocks in Act II.' },
  nationalMapActive: { ka: 'ახლა აქ ხარ', en: 'You are here' },
  nationalMapUnlocked: { ka: 'შენი ქსელი', en: 'Your network' },
  nationalMapClose: { ka: 'დახურვა', en: 'Close' },
  ...
  // ---------- V2 living-city HUD, placement and asset feedback ----------
  populationLabel: { ka: 'მოსახლეობა', en: 'Population' },
  jobsLabel: { ka: 'სამუშაოები', en: 'Jobs' },
  happinessLabel: { ka: 'ბედნიერება', en: 'Happiness' },
  cleanPowerLabel: { ka: 'სუფთა ენერგია', en: 'Clean power' },
  coverageLabel: { ka: 'ადგილობრივი მიწოდება', en: 'Local supply' },
  projectedNetLabel: { ka: 'შემდეგი კვარტალი', en: 'Next-quarter forecast' },
  cityLevelLabel: { ka: 'ქალაქის დონე', en: 'City level' },
  levelVillage: { ka: 'სოფელი', en: 'Village' },
  levelTown: { ka: 'დაბა', en: 'Town' },
  levelCity: { ka: 'ქალაქი', en: 'City' },
  levelGreenCity: { ka: 'მწვანე ქალაქი', en: 'Green city' },
  levelEnergyCapital: { ka: 'ენერგო-დედაქალაქი', en: 'Energy capital' },
  missionTitle: { ka: 'მისია', en: 'Mission' },
  missionAct1: { ka: 'მიაწოდე ენერგია ყველა სახლს 3 კვარტალი ზედიზედ.', en: 'Power every home for 3 quarters in a row.' },
  missionAct2: { ka: 'შექმენი ორი საიმედო რეგიონი და 200 MWh საცავი.', en: 'Build two reliable regions and 200 MWh of storage.' },
  missionAct3: { ka: 'შეამცირე გაზზე დამოკიდებულება და შეასრულე ევროპის კონტრაქტი.', en: 'Cut gas dependence and fulfil the Europe contract.' },
  placeOnMap: { ka: 'რუკაზე განთავსება', en: 'Place on map' },
  sitesAvailable: { ka: 'თავისუფალი ადგილი', en: 'sites available' },
  placementTitle: { ka: 'აირჩიე სამშენებლო ადგილი', en: 'Choose a construction site' },
  placementInstruction: { ka: 'დააჭირე მწვანე წრეს. ნაცრისფერი ადგილი დაკავებულია.', en: 'Click a green plot. Grey plots are occupied.' },
  placementCue: { ka: 'დააჭირე მოციმციმე მწვანე წრეს რუკაზე', en: 'Tap a glowing green circle on the map' },
  placementNoSites: { ka: 'შესაფერისი თავისუფალი ადგილი აღარ არის — დაანგრიე ობიექტი ან გაფართოვდი.', en: 'No suitable plots remain — demolish an asset or expand.' },
  cancelLabel: { ka: 'გაუქმება', en: 'Cancel' },
  assetInspectorTitle: { ka: 'ობიექტის მართვა', en: 'Asset inspector' },
  operationalStatus: { ka: 'მუშაობს', en: 'Operational' },
  constructionStatus: { ka: 'მშენებლობა', en: 'Under construction' },
  outputPerQuarter: { ka: 'გამომუშავება / კვარტალი', en: 'Output / quarter' },
  demolishLabel: { ka: 'დემონტაჟი', en: 'Demolish' },
  demolishCostLabel: { ka: 'დემონტაჟის ფასი', en: 'Demolition cost' },
  demolishWarning: { ka: 'ადგილი გათავისუფლდება, მაგრამ დახარჯული ინვესტიცია არ ბრუნდება.', en: 'The plot becomes free, but the original investment is not refunded.' },
  demolishConfirm: { ka: 'დაადასტურე დემონტაჟი', en: 'Confirm demolition' },
  selectAssetHint: { ka: 'მართვისთვის დააჭირე აშენებულ ობიექტს.', en: 'Click a built asset to inspect or remove it.' },
  impactNow: { ka: 'ახლავე', en: 'NOW' },
  impactOngoing: { ka: 'ყოველ კვარტალში', en: 'EVERY QUARTER' },
  permanentLabel: { ka: 'მუდმივი გადაწყვეტილება', en: 'Permanent decision' },
  estimatedLossLabel: { ka: 'სავარაუდო დანაკარგი', en: 'Estimated cost' },
  revenueKeptLabel: { ka: 'შენ გრჩება შემოსავლის', en: 'You keep revenue' },
  noRevenueYet: { ka: 'როგორც კი ქალაქი შემოსავალს მიიღებს', en: 'applies once the city earns revenue' },
  confirmChoice: { ka: 'ჯერ გადაამოწმე შედეგი', en: 'Review the impact first' },
  applyPolicy: { ka: 'გადაწყვეტილების მიღება', en: 'Apply decision' },
  cashChangedLabel: { ka: 'ბიუჯეტი შეიცვალა', en: 'Budget changed' },
  cityReactedLabel: { ka: 'ქალაქი რეაგირებს', en: 'City reacted' },
  reactionPowerUp: { ka: '„მეტი სახლი მიიღებს ენერგიას!“', en: '“More homes will have power!”' },
  reactionJobsUp: { ka: '„ჩვენთან ახალი სამუშაოებია!“', en: '“There are new jobs in town!”' },
  reactionTrustUp: { ka: '„კარგია, რომ ჩვენს ხმას უსმენენ.“', en: '“They are finally listening to us.”' },
  reactionDemolished: { ka: '„ადგილი თავისუფალია — მაგრამ ენერგია ხომ გვეყოფა?“', en: '“The plot is free — but will we still have enough power?”' },
  reactionRiskUp: { ka: '„ენერგიის მარაგი შემცირდა.“', en: '“Our power safety margin just fell.”' },
  coachTitle: { ka: 'პირველი მისია', en: 'First mission' },
  coachBuild: { ka: 'დაიწყე სუფთა სადგურით. აირჩიე მშენებლობა და განათავსე სათემო მზე მწვანე ველზე.', en: 'Start with clean power. Open Build and place Community Solar on a green field.' },
  coachCommunity: { ka: 'ჯერ თემის ნდობა მოიპოვე. სკოლის პროგრამა სათემო მზეს გახსნის.', en: 'Earn community trust first. A School Program will unlock Community Solar.' },
  coachRun: { ka: 'ქალაქი მზადაა. გაუშვი პირველი კვარტალი და ნახე, ეყოფა თუ არა ენერგია.', en: 'Your city is ready. Run the first quarter and see whether the power plan holds.' },
  openBuild: { ka: 'მშენებლობის გახსნა', en: 'Open Build' },
  openCommunity: { ka: 'თემთან მუშაობა', en: 'Work with Community' },
  ...
  rejMax: { ka: 'ამ ობიექტისთვის ადგილი აღარ არის', en: 'no more local capacity for this asset' },
  rejNoSlot: { ka: 'თავისუფალი ადგილი არ არის', en: 'no free slot' },
  rejSlotTaken: { ka: 'ეს ადგილი დაკავებულია — აირჩიე მწვანე წრე', en: 'This plot is taken — pick a green circle' },
  ...
  rejPlantMissing: { ka: 'ობიექტი აღარ არსებობს', en: 'asset no longer exists' },
  rejDemolishMoney: { ka: 'დემონტაჟისთვის თანხა არ გყოფნის', en: 'not enough money for demolition' },
  rejContractAsset: { ka: 'აქტიური კონტრაქტის ხაზს ვერ დაშლი', en: 'cannot remove the route used by an active contract' },
